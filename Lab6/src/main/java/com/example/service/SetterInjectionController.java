...
public class SetterInjectionController {
	...
	@Autowired
	public SetterInjectionController(CustomerService customerService) {
		this.customerService = customerService;
	}

	@GetMapping("/{id}") // http://localhost:8080/setter/47
	...
	@GetMapping("/customer/{id}/{name}") // http://localhost:8080/setter/customer/04/Nattawadee
